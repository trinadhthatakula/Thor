...
**Band A is built, and band B's Freezer half with it — start at #14.** Rows 13, 15, 16, 17, 18 and 22
have shipped; 14, 19, 20 and 21 are the Apps-tab remainder and are what is left of band B. Band A's
numbers are frozen where they are; see the sweep note above for why they are not being reclaimed, and
why the one item band A itself created carries no number.
